 ...
 */
export declare const STACKS_NETWORKS: {
    readonly MAINNET: NetworkV2;
    readonly TESTNET: NetworkV2;
};
/**
 ...
 */
export declare const X402_ERROR_CODES: {
    ...
    readonly INVALID_TRANSACTION_STATE: "invalid_transaction_state";
    readonly UNEXPECTED_VERIFY_ERROR: "unexpected_verify_error";
    readonly UNEXPECTED_SETTLE_ERROR: "unexpected_settle_error";
    readonly RECIPIENT_MISMATCH: "recipient_mismatch";
    readonly AMOUNT_INSUFFICIENT: "amount_insufficient";
    readonly SENDER_MISMATCH: "sender_mismatch";
    readonly TRANSACTION_NOT_FOUND: "transaction_not_found";
    readonly TRANSACTION_PENDING: "transaction_pending";
